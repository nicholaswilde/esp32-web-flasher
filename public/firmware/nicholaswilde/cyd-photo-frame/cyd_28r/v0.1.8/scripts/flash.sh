...
#
# Usage: bash -c "$(curl -fsSL https://raw.githubusercontent.com/nicholaswilde/cyd-photo-frame/main/scripts/flash.sh)" _ [DEVICE] [SERIAL_PORT]
...
# --- variables ---
GITHUB_REPO="nicholaswilde/cyd-photo-frame"
DEVICE="${1:-cyd_28r}"
